...
* [1 SELECT from name](https://sqlzoo.net/wiki/SELECT_names) [Solution](SELECT_from_name.md)
...
* [5 SUM and COUNT](https://sqlzoo.net/wiki/SUM_and_COUNT) [Solution](SUM_and_COUNT.md)
* [6 The JOIN opration](https://sqlzoo.net/wiki/The_JOIN_operation) [Solution](The_JOIN_operation.md)
